...
▼ [netlify/functions/getCurrentWeather.mts](https://github.com/mimimiRoni/FeelingWeather/blob/develop/netlify/functions/getCurrentWeather.mts){target=blank .external-link}
