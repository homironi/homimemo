...
description: Unityのエディタ拡張機能の、PropertyAttributeとPropertyDrawerを使って、フィールドや配列のInspectorでの表示をカスタムしてみましょう。一度定義すれば、簡単に表示をカスタムできるAttributeとして使用できます。また、Unity6000からは、PropertyAttribute.applyToCollection を使うことで配列やListのようなコレクションに対してAttributeを適用することができるようになりました。そちらのご紹介も兼ねて、Inspectorでの表示名を変数名とは別の名前をつけられるようにする拡張を紹介します。
...
→[PropertyAttribute.applyToCollection](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/PropertyAttribute-applyToCollection.html){target=blank .external-link}

## PropertyDrawer について

公式のリファレンスはこちら → [PropertyDrawer](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/PropertyDrawer.html){target=blank .external-link}
...
公式マニュアル：[Create a Custom Inspector](https://docs.unity3d.com/6000.0/Documentation/Manual/UIE-HowTo-CreateCustomInspector.html){target=blank .external-link}
...
ここは、UI Toolkit の [PropertyField](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/UIElements.PropertyField.html){target=blank .external-link} という UI 要素を作成しています。  
詳細は省きますが、`SerializedProperty` をもとにそのプロパティを表示するためのエディタ用の UI 要素を作成してくれます。  
[SerializedProperty](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/SerializedProperty.html){target=blank .external-link} についても詳細は省きますが、  
...
-   [PropertyAttribute](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/PropertyAttribute.html){target=blank .external-link}
-   [PropertyDrawer](https://docs.unity3d.com/6000.0/Documentation/ScriptReference/PropertyDrawer.html){target=blank .external-link}
-   [Create a Custom Inspector](https://docs.unity3d.com/6000.0/Documentation/Manual/UIE-HowTo-CreateCustomInspector.html){target=blank .external-link}
