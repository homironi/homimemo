...
publishDate: 2023-12-19T00:00:00.000+09:00
lastModDate: 2024-08-31T00:00:00.000+09:00
draft: false
category: 開発系その他
tags:
  - GitHubActions
thumbnail: /images/header/articles/teuoslm5qrtzhh4lqkqlm34a.webp
---
...
1. リポジトリ内で、上部メニューの「Actions」をクリック  
   ![GitHubのActions](/images/article/migrated/categories/developOther/0/GitHub_Actions.webp)
1. ワークフローがまだ設定されていない場合は、「Set up a workflow yourself」を選択。  
   ![Set up a workflow yourself](/images/article/migrated/categories/developOther/0/GitHub_Actions_setupWorkflow.webp)  
   既存のワークフローがある場合は、「New workflow」ボタンをクリック  
   ![New workflow](/images/article/migrated/categories/developOther/0/GitHub_Actions_newWorkflow.webp)
1. エディタが開いたら、そこに後述する`deployMain.yaml`の内容を貼り付け
1. エディタでコードを貼り付けたら、「Commit changes...」をクリック  
   ![workFlowCode](/images/article/migrated/categories/developOther/0/GitHub_workflowCode.webp)
1. 適切なコミットメッセージを入力し、「Commit changes」をクリック  
   ![commit](/images/article/migrated/categories/developOther/0/GitHub_Actions_commit.webp)
...
1. リポジトリ内で、上部メニューの「Settings」をクリック  
   ![Settings](/images/article/migrated/categories/developOther/0/GitHub_repo.webp)
1. 「secrets and variables」＞「Actions」を選択  
   ![secretsAndVariables](/images/article/migrated/categories/developOther/0/GitHub_secret.webp)
1. 「New repository secret」を選択  
   ![newVariable](/images/article/migrated/categories/developOther/0/GitHub_secret_newVariable.webp)
...
1. 「Add secret」を選択してシークレット変数を追加  
   ![add secret](/images/article/migrated/categories/developOther/0/GitHub_secret_add.webp)
...
2. **サーバー ID**が表示されていると思うので、それを確認  
   ...
   ![serverPane](/images/article/migrated/categories/developOther/0/Xserver_panel.webp)
3. 続いて「サーバー情報」をクリック
4. サーバー情報のページで、**ホスト名**と**ホームディレクトリ**を確認  
   それぞれコードの、`svhoge`→ ホスト名、`/home/hogegege`→ ホームディレクトリを置き換え  
   ![serverInfo](/images/article/migrated/categories/developOther/0/Xserver_serverInfo.webp){/*width="50%"*/}
...
![result](/images/article/migrated/categories/developOther/0/GitHub_Actions_result.webp)
...
![SSH設定](/images/article/migrated/categories/developOther/0/SSHSettings.webp)
