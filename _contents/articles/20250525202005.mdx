...
thumbnail: /images/header/articles/gerhmam3hcmi9lbrgs3frm11.webp
...
-   [https://github.com/firebase/firebase-tools/issues/2764](https://github.com/firebase/firebase-tools/issues/2764)
-   [https://github.com/firebase/firebase-tools/issues/5821](https://github.com/firebase/firebase-tools/issues/5821)
...
[こちらの記事](/articles/2p1wt6y9byaq875c4kln2yra/)でも書いていますが、`.env`を使えばデプロイし直さなくても問題なさそうです。
...
<TextBlock blockType="info">
`.env` の話は[こちらの記事](/articles/2p1wt6y9byaq875c4kln2yra/)でも書いているので、もしよければご覧ください！
</TextBlock>
...
-   [https://github.com/firebase/firebase-tools/issues/2764](https://github.com/firebase/firebase-tools/issues/2764)
-   [https://github.com/firebase/firebase-tools/issues/5821](https://github.com/firebase/firebase-tools/issues/5821)
-   [vercel dev の際にローカルで環境変数を指定したい！](/articles/2p1wt6y9byaq875c4kln2yra/)
