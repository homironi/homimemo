...
export const LongTitle: Story = {
  args: {
    meta: {
      ...sampleMeta,
      title:
        "非常に長いタイトルのサンプル記事です。これはテスト用の長いタイトルで、カードのレイアウトが崩れないか確認するために使用されます。非常に長いタイトルのサンプル記事です。これはテスト用の長いタイトルで、カードのレイアウトが崩れないか確認するために使用されます。",
    },
  },
};
